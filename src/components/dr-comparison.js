...
const CHECK_ROWS = ['Featured on the homepage', '41+ DR dofollow backlink', 'Seen by thousands of founders'];
  ...
  <section class="py-12 sm:py-16">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-500 mt-2">Every plan ships a do-follow 41+ DR backlink. Here's the before and after.</p>
      </div>
      ...
      <div class="grid sm:grid-cols-2 gap-4">
        ...
        <div class="bg-white rounded-2xl border border-orange-300 ring-1 ring-orange-200 p-6">
          ...
          <div class="flex items-baseline gap-2 mt-1 mb-4">
            ...
            <span class="text-3xl font-bold tracking-tight text-orange-600">41+</span>
          </div>
          <ul class="space-y-2.5 text-sm">
