          ...
          window.location.href = '/submit?plan=premium';
                  ...
                  >
                    ...
                    ${formData.plan === 'premium' ? html`
                      ...
                      <!-- Removed: a hardcoded "2 of 3 slots left today" + a 15-minute
                           countdown that restarted on every page load. Neither was backed
                           by anything — invented scarcity. Don't reintroduce it. -->
