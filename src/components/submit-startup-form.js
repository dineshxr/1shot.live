        ...
        ` : html`
          <div class="mb-4 bg-yellow-300 p-3 border border-black rounded">
            <p class="font-bold flex items-center">
              <span class="mr-2">🚀</span> Submit Your Startup, Get a 41+ DR Backlink
            </p>
          ...
          window.location.href = '/submit?plan=premium';
                  ...
                  >
                    ...
                    <ul class="list-disc pl-5 space-y-1 mb-3">
                      ...
                      <li><strong>Dofollow backlink (41+ DR)</strong></li>
