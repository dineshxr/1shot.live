    ...
    renderUnlockStatus() {
        ...
        body.innerHTML = `
            ...
            <div class="mt-3 flex items-start gap-2 text-xs text-gray-500">
                ...
                <span><span class="font-semibold text-gray-600">Optional:</span> add a do-follow SubmitHunt badge to each product's own site to claim a permanent DR 41+ backlink. Skip it and you still launch — you just forfeit the link equity.</span>
            </div>
                    ...
                    <div class="border-t border-gray-200 pt-4 mt-4">
                        <div class="rounded-lg border border-amber-200 bg-amber-50 p-3">
                            <p class="text-[13px] text-amber-800 leading-snug">
                                ...
                                <strong>No do-follow backlink yet.</strong> Add our badge to your product's site, then verify it here to claim your free DR 41+ backlink and the gold verified checkmark.
                            </p>
