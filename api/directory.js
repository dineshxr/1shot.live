...
const FEATURED = {
  name: 'SubmitHunt', url: SITE, submit: '/submit', dr: 44,
...
export default async function handler(req, res) {
  ...
  const html =
    ...
    `<meta property="og:image" content="${SITE}/og-image.png?v=44" /><meta property="og:site_name" content="SubmitHunt" />` +
    `<meta name="twitter:card" content="summary_large_image" /><meta name="twitter:image" content="${SITE}/og-image.png?v=44" />` +
