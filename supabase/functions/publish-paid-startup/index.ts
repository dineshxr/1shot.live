  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; margin-top: 20px; margin-bottom: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="padding: 30px;">
      ...
      <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); border-radius: 8px; padding: 25px; margin: 25px 0;">
        ...
        <p style="margin: 0; color: #fff; font-size: 14px; line-height: 1.6; opacity: 0.95;">
          ${listing.title} has priority placement and stays on the homepage for 14 days — double the standard run. Your guaranteed dofollow backlink (DR 44+) goes live within 24 hours, and we'll feature you in our next newsletter to 2,000+ subscribers.
        </p>
      </div>
      `}
    ...
    <div style="padding: 30px;">
      ...
      <div style="margin: 24px 0;">
        ...
        <table style="width: 100%;" cellpadding="0" cellspacing="0">
          ...
          <tr><td style="padding: 5px 0; color: #555; font-size: 14px;">3. ${isFeatured ? 'Your Featured placement runs for 7 days from launch' : 'You stay on the homepage for 14 days from launch'}, with your guaranteed dofollow backlink (DR 44+)</td></tr>
        </table>
      </div>
...
3. ${isFeatured ? 'Your Featured placement runs for 7 days from launch' : 'You stay on the homepage for 14 days from launch'}, with your guaranteed dofollow backlink (DR 44+)
