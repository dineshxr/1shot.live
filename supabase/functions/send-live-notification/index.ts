    ...
    <div style="padding: 30px;">
      ...
      <div style="background: #1a1a1a; border-radius: 8px; padding: 28px; margin: 25px 0;">
        ...
        <p style="margin: 0 0 20px 0; color: #ccc; font-size: 14px; line-height: 1.6;">
          Most founders pay $50-200 for a single backlink from a DR 41+ site. With a Premium upgrade, you get one automatically &mdash; plus your listing stays on the homepage for 14 days instead of 7.
        </p>
      ...
      <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); border-radius: 8px; padding: 25px; margin: 25px 0;">
        ...
        <p style="margin: 0; color: #fff; font-size: 14px; line-height: 1.6; opacity: 0.95;">
          Your listing has priority placement and extended homepage visibility. Your dofollow backlink (41+ DR) will be live within 24 hours. We'll also feature ${startup.title} in our next newsletter to 2,000+ subscribers.
        </p>
      </div>
      `}
