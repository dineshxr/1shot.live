  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; margin-top: 20px; margin-bottom: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div style="padding: 30px;">
      ...
      <div style="background-color: #eff6ff; border-left: 4px solid #3b82f6; border-radius: 0 8px 8px 0; padding: 20px; margin: 25px 0;">
        <h3 style="margin: 0 0 8px 0; color: #1e40af; font-size: 16px;">Don't leave your free DR 41+ backlink on the table</h3>
        <p style="margin: 0 0 14px 0; color: #1e3a8a; font-size: 14px; line-height: 1.6;">
          You skipped the badge step. Add our badge to your homepage or footer (keep it do-follow) before launch day and your listing becomes <strong>permanent</strong> — and your backlink from our DR 41+ site stays <strong>dofollow</strong>. Free either way.
        </p>
      ...
      <div style="background: #1a1a1a; border-radius: 8px; padding: 26px; margin: 25px 0;">
        ...
        <p style="margin: 0 0 18px 0; color: #ccc; font-size: 14px; line-height: 1.6;">
          Premium launches go live immediately instead of waiting for a free slot — and stay on the homepage for 14 days instead of 7, with a guaranteed dofollow backlink from our DR 41+ site and a spot in our newsletter to 2,000+ subscribers.
        </p>
...
${showBadgeReminder ? `DON'T LEAVE YOUR FREE DR 41+ BACKLINK ON THE TABLE
You skipped the badge step. Add our badge to your homepage or footer (keep it do-follow) before launch day and your listing becomes permanent — and your backlink from our DR 41+ site stays dofollow. Free either way.
