  ...
  const freeUpsellHtml = `
      <div style="background: #1a1a1a; border-radius: 8px; padding: 24px; margin: 25px 0;">
        ...
        <p style="margin: 0 0 16px 0; color: #ccc; font-size: 14px; line-height: 1.6;">
          Free listings stay on the homepage for 7 days. Premium keeps ${title} there for 14 — twice the window for comments like this one to turn into users — and locks in a guaranteed dofollow backlink from our DR 44+ site.
        </p>
...
Free listings stay on the homepage for 7 days. Premium keeps ${p.startupTitle} there for 14 — twice the window for comments like this one to turn into users — and locks in a guaranteed dofollow backlink from our DR 44+ site.
